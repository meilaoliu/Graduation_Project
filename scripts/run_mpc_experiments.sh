...
#
# 使用方法:
#   scripts/run_mpc_experiments.sh              # 显示帮助
#   scripts/run_mpc_experiments.sh baseline     # 实验1: 完整MPC (前馈+延时补偿)
#   scripts/run_mpc_experiments.sh no_ff        # 实验2: 关闭前馈 (消融)
#   scripts/run_mpc_experiments.sh no_delay     # 实验3: 关闭延时补偿 (消融)
#
# 每次实验结束后:
...
ADVANCED_PARAM="$WORKSPACE_ROOT/src/ego-planner/planner/plan_manage/launch/advanced_param.xml"
